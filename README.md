...
- [🦀 SocialCrabs](#-socialcrabs)
  ...
  - [🔄 Workflow](#-workflow)
    ...
    - [Agent-Driven Comments (CRITICAL)](#agent-driven-comments-critical)
      - [How It Works:](#how-it-works)
      - [VOICE.md Example:](#voicemd-example)
  ...
  - [📦 Installation](#-installation)
    ...
    - [🤖 AI Agent Instructions](#-ai-agent-instructions)
      ...
      - [🔄 Autonomous Engagement](#-autonomous-engagement)
  ...
  - [📡 API Reference](#-api-reference)
    ...
    - [Twitter Endpoints](#twitter-endpoints)
    - [System Endpoints](#system-endpoints)
  - [⚙️ Configuration](#️-configuration)
    - [Environment Variables](#environment-variables)
      - [Platform Credentials](#platform-credentials)
    - [Rate Limits](#rate-limits)
      - [Production Limits (After 5-Week Warm-Up)](#production-limits-after-5-week-warm-up)
      - [Week 1 Warm-Up Limits (New Accounts)](#week-1-warm-up-limits-new-accounts)
      - [Action Timing Rules](#action-timing-rules)
    - [Notifications](#notifications-1)
      - [Notification Environment Variables](#notification-environment-variables)
      - [Example .env for Telegram Notifications](#example-env-for-telegram-notifications)
